...
import { levelPageBackgroundImage, levelPageButtonContainer, levelPageButtonContainerOne, levelPageButtonContainerTwo, levelPageContainer, levelPageMainContainer, levelPageTitle } from '../styles/LevelPage.css';

...
const MyLearningPage = () => {
  ...
  const [detailUserData, setDetailUserData] = useState<QuizDataItem | undefined>();
  ...
  const handleCheckAndGetData = (e: React.MouseEvent<HTMLDivElement, MouseEvent>, getData: QuizDataItem, index: number) => {
    e.stopPropagation();
    setIsClicked(true);
